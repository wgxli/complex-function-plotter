...
var grammar = {
    ...
    {"name": "unaryFunction$string$11", "symbols": [{"literal":"c"}, {"literal":"o"}, {"literal":"n"}, {"literal":"j"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "unaryFunction", "symbols": ["unaryFunction$string$11"]},
    {"name": "unaryFunction$string$12", "symbols": [{"literal":"r"}, {"literal":"e"}, {"literal":"a"}, {"literal":"l"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "unaryFunction", "symbols": ["unaryFunction$string$12"]},
    {"name": "unaryFunction$string$13", "symbols": [{"literal":"i"}, {"literal":"m"}, {"literal":"a"}, {"literal":"g"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "unaryFunction", "symbols": ["unaryFunction$string$13"]},
    {"name": "unaryFunction$string$14", "symbols": [{"literal":"r"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "unaryFunction", "symbols": ["unaryFunction$string$14"], "postprocess": () => ['real']},
    {"name": "unaryFunction$string$15", "symbols": [{"literal":"i"}, {"literal":"m"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "unaryFunction", "symbols": ["unaryFunction$string$15"], "postprocess": () => ['imag']},
    {"name": "unaryFunction$string$16", "symbols": [{"literal":"s"}, {"literal":"m"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "unaryFunction", "symbols": ["unaryFunction$string$16"]},
    {"name": "unaryFunction$string$17", "symbols": [{"literal":"c"}, {"literal":"m"}], "postprocess": function joiner(d) {return d.join('');}},
