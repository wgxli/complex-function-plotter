...
var grammar = {
    ...
    {"name": "function", "symbols": ["binaryFunction", {"literal":"["}, "sum", {"literal":","}, "_", "sum", {"literal":"]"}], "postprocess": data => [data[0][0], data[2], data[5]]},
    {"name": "function", "symbols": ["fourFunction", {"literal":"("}, "sum", {"literal":","}, "_", "sum", {"literal":","}, "_", "sum", {"literal":","}, "_", "sum", {"literal":")"}], "postprocess": data => [data[0][0], data[2], data[5], data[8], data[11]]},
    {"name": "function", "symbols": ["fourFunction", {"literal":"["}, "sum", {"literal":","}, "_", "sum", {"literal":","}, "_", "sum", {"literal":","}, "_", "sum", {"literal":"]"}], "postprocess": data => [data[0][0], data[2], data[5], data[8], data[11]]},
