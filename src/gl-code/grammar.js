...
var grammar = {
    ...
    {"name": "namedFunction", "symbols": ["trigFunction"]},
    ...
    {"name": "namedFunction$string$16", "symbols": [{"literal":"s"}, {"literal":"m"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "namedFunction", "symbols": ["namedFunction$string$16"]},
    {"name": "namedFunction$string$17", "symbols": [{"literal":"c"}, {"literal":"m"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "namedFunction", "symbols": ["namedFunction$string$17"]},
