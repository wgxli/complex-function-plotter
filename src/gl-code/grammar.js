...
var grammar = {
    ...
    {"name": "function", "symbols": ["unaryFunction", {"literal":"["}, "_", "sum", "_", {"literal":"]"}], "postprocess": data => [data[0][0], data[3]]},
    {"name": "function", "symbols": ["binaryFunction", {"literal":"("}, "_", "sum", {"literal":","}, "_", "sum", {"literal":")"}], "postprocess": data => [data[0][0], data[3], data[6]]},
    {"name": "function", "symbols": ["binaryFunction", {"literal":"["}, "_", "sum", {"literal":","}, "_", "sum", {"literal":"]"}], "postprocess": data => [data[0][0], data[3], data[6]]},
    {"name": "function", "symbols": ["fourFunction", {"literal":"("}, "_", "sum", {"literal":","}, "_", "sum", {"literal":","}, "_", "sum", {"literal":","}, "_", "sum", {"literal":")"}], "postprocess": data => [data[0][0], data[3], data[6], data[9], data[12]]},
    {"name": "function", "symbols": ["fourFunction", {"literal":"["}, "_", "sum", {"literal":","}, "_", "sum", {"literal":","}, "_", "sum", {"literal":","}, "_", "sum", {"literal":"]"}], "postprocess": data => [data[0][0], data[3], data[6], data[9], data[12]]},
    ...
    {"name": "binaryFunction$string$10", "symbols": [{"literal":"d"}, {"literal":"e"}, {"literal":"r"}, {"literal":"i"}, {"literal":"v"}, {"literal":"a"}, {"literal":"t"}, {"literal":"i"}, {"literal":"v"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binaryFunction", "symbols": ["binaryFunction$string$10"], "postprocess": () => ['diff']},
    {"name": "binaryFunction$string$11", "symbols": [{"literal":"d"}, {"literal":"i"}, {"literal":"f"}, {"literal":"f"}], "postprocess": function joiner(d) {return d.join('');}},
