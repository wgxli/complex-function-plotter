...
var grammar = {
    ...
    {"name": "function", "symbols": ["unaryFunction", {"literal":"("}, "sum", {"literal":")"}], "postprocess": data => [data[0], data[2]]},
    {"name": "function", "symbols": ["unaryFunction", {"literal":"["}, "sum", {"literal":"]"}], "postprocess": data => [data[0], data[2]]},
    ...
    {"name": "binaryFunction$string$10", "symbols": [{"literal":"s"}, {"literal":"m"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "binaryFunction", "symbols": ["binaryFunction$string$10"]},
    {"name": "binaryFunction$string$11", "symbols": [{"literal":"c"}, {"literal":"m"}], "postprocess": function joiner(d) {return d.join('');}},
